  ...
  <div>
    ...
    <dl class="music-info">
      ...
      <template v-else>
        <dd>X-Music</dd>
        <dd>
          <a class="hover" target="_blank" href="https://github.com/X29w">
            <mm-icon type="github" :size="14" />&nbsp;X-29
          </a>
        </dd>
      </template>
    </dl>
    ...
    <div ref="musicLyric" class="music-lyric">
      <div class="music-lyric-items" :style="lyricTop">
        <p v-if="!currentMusic.id">有没有想听的呢</p>
        <p v-else-if="nolyric">我想不出来歌词，你编吧</p>
